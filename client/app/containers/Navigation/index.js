...
class Navigation extends React.PureComponent {
  ...
  render() {
    ...
    const inputProps = {
      placeholder: 'Search Search News',
      value: searchValue,
      onChange: (_, { newValue }) => {
        onSearch(newValue);
      }
          ...
          <Container>
            <Row>
              <Col md='4' className='text-center d-none d-md-block'>
                <i className='fa fa-graduation-cap' />  {/* Changed icon to graduation cap */}
                <span>Free Education</span>  {/* Changed text */}
              </Col>
              <Col md='4' className='text-center d-none d-md-block'>
                <i className='fa fa-question-circle' />
                <span>Quiz Methods</span>
              </Col>
              <Col md='4' className='text-center d-none d-md-block'>
                <i className='fa fa-phone' />
                <span>Call us 9747414972</span>
              </Col>
              <Col xs='12' className='text-center d-block d-md-none'>
                <i className='fa fa-phone' />
                <span> Need advice? Call us 9747414972</span>
              </Col>
            </Row>
          </Container>
        </div>
            ...
            >
              <Navbar color='light' light expand='md' className='mt-1 mt-md-0'>
                ...
                <Nav navbar>
                  ...
                  {/* // In the render() method, find this section: */}
                    ...
                    <Nav navbar>
                      ...
                      <NavItem>
                        <UncontrolledDropdown nav inNavbar>
                          ...
                          <DropdownMenu right>
                            <DropdownItem onClick={() => history.push('/news')}>
                              <i className="fas fa-newspaper mr-2"></i>
                              All News
                            </DropdownItem>
                            <DropdownItem onClick={() => history.push('/todays-news')}>
                              <i className="fas fa-calendar-day mr-2"></i>
                              Today's News
                            </DropdownItem>
                            {/* <DropdownItem onClick={() => history.push('/news/categories')}>
